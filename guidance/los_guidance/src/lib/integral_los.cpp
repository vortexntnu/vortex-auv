...
namespace vortex::guidance::los {
    ...
    IntegralLOSGuidance::IntegralLOSGuidance(const IntegralLosParams& params): m_params{params} {}
    ...
    types::CrossTrackError IntegralLOSGuidance::calculate_crosstrack_error(const types::Inputs& inputs) {
    ...
    types::Outputs IntegralLOSGuidance::calculate_outputs(const types::Inputs& inputs) {
        ...
        const double u_h = m_params.k_p_h * e.y_e + m_params.k_i_h * int_h;
        const double u_v = m_params.k_p_v * e.z_e + m_params.k_i_v * int_v;
