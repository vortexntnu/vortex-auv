...
types::Outputs ProportionalLOSGuidance::calculate_outputs(
    ...
    const double desired_yaw = path_heading_ - std::atan(k_p_h * cross_track_error.y_e);
    const double desired_pitch = path_pitch_ + std::atan(k_p_v * cross_track_error.z_e);
