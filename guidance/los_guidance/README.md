...
vortex_msgs/action/LOSWaypoint \
"{los_waypoint: {waypoints: {x: 1.0, y: 2.0, z: 3.0}}, convergence_threshold: 0.3}"
```
...
|----------|------|------|---------|
| Action Server | `/drone_name/los_guidance` | Goal input | `vortex_msgs/action/LOSWaypoint` |
