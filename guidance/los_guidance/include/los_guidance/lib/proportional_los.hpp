/**
 * @file proportional_los.hpp
 * @brief Defines the ProportionalLOSGuidance class and parameter structure for
 * the proportional LOS guidance algorithm.
 */
...
/**
 * @brief Implements the proportional LOS guidance algorithm.
 *
 * This class computes desired heading and pitch commands using proportional
 * cross-track error feedback.
 */
class ProportionalLOSGuidance {
   public:
    /**
     * @brief Constructs a ProportionalLOSGuidance object.
     * @param params Parameters for the proportional LOS guidance algorithm.
     */
    explicit ProportionalLOSGuidance(const ProportionalLosParams& params);

    /**
     * @brief Destroys the ProportionalLOSGuidance object.
     */
    ~ProportionalLOSGuidance() = default;

    /**
     * @brief Calculates the desired LOS guidance outputs.
     * @param inputs Input values required for proportional LOS computation.
   ...
   private:
    ...
    /**
     * @brief Parameters used by the proportional LOS guidance algorithm.
     */
