...
class LOSGuidanceCalculator:
    ...
    def compute_los_guidance(self, current_pos, target_pos):
        ...
        desired_pitch = self.compute_pitch_command(depth_error,
                                                   horizontal_distance)

        # Compute desired surge velocity
        desired_surge = self.compute_desired_speed(yaw_error,
                                                   horizontal_distance)
    ...
    def compute_desired_speed(self, yaw_error, distance):
        ...
        yaw_factor = math.cos(
            yaw_error)  # cos gives smooth reduction for large errors
    ...
    def compute_pitch_command(self, depth_error, horizontal_distance):
        ...
        return np.clip(modified_pitch, -self.max_pitch_angle,
    ...
    def get_debug_info(self, guidance_commands):
        ...
        return {
            ...
            'Pitch angle':
            f"{math.degrees(guidance_commands['pitch']):.1f} deg",
