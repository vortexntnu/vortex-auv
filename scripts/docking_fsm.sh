...
tmux split-window -h -t "docking-fsm:0.3"
...
tmux send-keys -t "docking-fsm:0.3" "ros2 launch ekf_pose_filtering ekf_pose_filtering.launch.py" C-m
tmux send-keys -t "docking-fsm:0.4" "ros2 launch stonefish_sim simulation_nogpu.launch.py" C-m
