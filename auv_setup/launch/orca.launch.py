...
def generate_launch_description():
    ...
    PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('thruster_allocator_auv'),'launch','thruster_allocator_auv.launch.py')
        )
    )
    ...
    PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('thruster_interface_auv'),'launch','thruster_interface_auv.launch.py')
        )
    )
