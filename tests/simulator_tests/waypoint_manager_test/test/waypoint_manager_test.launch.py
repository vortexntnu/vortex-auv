...
#         Cannot be used with persistent missions.
...
#         resp = self.spin_until_future_complete(future, timeout_sec=10.0)
#         return resp
...
#         """
#         initial_wp = make_waypoint(3.0, 0.0, 1.0)
...
#         goal_handle = self.spin_until_future_complete(send_future, timeout_sec=180.0)
