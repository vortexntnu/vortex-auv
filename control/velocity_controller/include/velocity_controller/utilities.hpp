...
// TODO: fix these so that changing the quaternions changes the angles, so that
...
class Guidance_data {
   public:
    ...
    double pitch = 0.0;
    double yaw = 0.0;
    // Guidance_data(vortex_msgs::msg::LOSGuidance
    // msg):State{msg.surge,msg.pitch,msg.yaw}{};
