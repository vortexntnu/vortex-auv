...
Vector6d PIDController::calculate_tau(const Eta &eta, const Eta &eta_d, const Nu &nu, const Eta &eta_dot_d) {
  ...
  Vector6d tau = -(Kp_ * j_inv * error.to_vector() + Ki_ * j_inv * integral_ + Kd_ * error_nu);
