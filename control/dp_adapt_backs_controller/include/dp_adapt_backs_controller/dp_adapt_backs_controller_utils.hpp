...
// @return 6D vector containing the error between the desired and actual vehicle pose
...
dp_types::Vector3d quat_to_euler(const double w, const double x, const double y, const double z);
...
dp_types::J_matrix calculate_J(const dp_types::Eta& eta);
...
// @param I_b_nu_2 : 3D vector containing the product of inertia matrix and angular velocity
// @return 6x6 coriolis matrix
dp_types::Matrix6d calculate_C(double m, const dp_types::Vector3d& r_b_bg, const dp_types::Nu& nu_2, const dp_types::Nu& I_b_nu_2);
