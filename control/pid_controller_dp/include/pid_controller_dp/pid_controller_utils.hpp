...
// @param dt: Time step
// @param error: 7D vector containing the error between the desired and actual
// vehicle pose [x, y, z, w, x, y, z]
// @param integral: 7D vector containing the integral term of the PID controller
// [x, y, z, w, x, y, z]
