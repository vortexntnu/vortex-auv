...
private:
  ...
  template<typename T> void getParameters(std::string param_name, T &param_variable);

  void cfgCallback(dp_reference_model::DpReferenceModelConfig &config, uint32_t level);
  dynamic_reconfigure::Server<dp_reference_model::DpReferenceModelConfig> m_cfg_server;
