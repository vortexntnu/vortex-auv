...
void QuaternionPdController::init(double a, double b, double c, double i, double W, double B,
...
Eigen::Vector6d QuaternionPdController::getFeedback(const Eigen::Vector3d& x, const Eigen::Quaterniond& q,
...
{
  return (Eigen::Matrix6d() << R.transpose() * m_K_x, Eigen::MatrixXd::Zero(3, 3), Eigen::MatrixXd::Zero(3, 3),
...
{
  return (Eigen::Matrix6d() << R.transpose() * m_K_i, Eigen::MatrixXd::Zero(3, 3), Eigen::MatrixXd::Zero(3, 3),
...
Eigen::Vector6d QuaternionPdController::errorVector(const Eigen::Vector3d& x, const Eigen::Vector3d& x_d,
...
bool QuaternionPdController::circleOfAcceptance(const Eigen::Vector3d& x, const Eigen::Vector3d& x_d, float R)
{
  // float R = 1.0;
...
Eigen::Vector3d QuaternionPdController::referenceModel(const Eigen::Vector3d& x, const Eigen::Vector3d& x_ref)
{
  Eigen::Vector3d x_d;
