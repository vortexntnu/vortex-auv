...
public:
  ControllerTest() {
    cmdPub =
        nh.advertise<vortex_msgs::PropulsionCommand>("propulsion_command", 10);
  ...
  void PublishCommand(boost::array<double, 6> motion,
...
TEST_F(ControllerTest, CheckResponsiveness) { WaitForMessage(); }
