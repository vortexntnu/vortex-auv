...
class ThrusterInterfaceAUVNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter(
            "coeffs.10V.LEFT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.10V.RIGHT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.12V.LEFT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.12V.RIGHT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.14V.LEFT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.14V.RIGHT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.16V.LEFT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.16V.RIGHT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.18V.LEFT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.18V.RIGHT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.20V.LEFT", None, ParameterDescriptor(dynamic_typing=True)
        )
        self.declare_parameter(
            "coeffs.20V.RIGHT", None, ParameterDescriptor(dynamic_typing=True)
        )
