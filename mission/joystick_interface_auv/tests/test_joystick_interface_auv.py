...
class TestJoystickInterface:
    ...
    # When the killswitch button is activated in the buttons list, it should
    # output a wrench msg with only zeros
    ...
    # When we move into XBOX mode it should still be able to return this
    # wrench message
