...
def generate_launch_description() -> LaunchDescription:
    ...
    """
    config = os.path.join(get_package_share_directory('dock_action_servers'),
                           'config',
                           'params.yaml')
    ...
    return LaunchDescription(
        initial_entities=[
            ...
            Node(package='docking_cpp', executable='docking', name='docking', parameters=[config], on_exit=launch.actions.LogInfo(msg="Docking exited")),
