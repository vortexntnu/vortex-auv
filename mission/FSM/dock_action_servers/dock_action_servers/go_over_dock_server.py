...
class GoOverDockServer(Node):

    def __init__(self) -> None:
        super().__init__('go_over_dock_server')

        self._action_server = ActionServer(self, GoToWaypoint, '/go_right_over', self.execute_callback)
