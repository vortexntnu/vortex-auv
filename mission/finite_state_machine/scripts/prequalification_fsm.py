...
def main():
    ...
    with prequalification_state_machine:
        ...
        StateMachine.add(
            "PREQUAL_PREPARE", ReachDepth(), transitions={"succeeded": "GATE_SM"}
        )
        ...
        with gate_sm:
            ...
            StateMachine.add(
                "GATE_SEARCH", GateSearch(), transitions={"succeeded": "GATE_CONVERGE"}
            )
        ...
        StateMachine.add("GATE_SM", gate_sm, transitions={"succeeded": "POLE_SM"})
        ...
        with pole_sm:
            ...
            StateMachine.add(
                "POLE_SEARCH", PoleSearch(), transitions={"succeeded": "POLE_CONVERGE"}
            )
        ...
        StateMachine.add("POLE_SM", pole_sm, transitions={"succeeded": "GATE_SM_BACK"})
    ...
    intro_server = IntrospectionServer(
        str(rospy.get_name()), prequalification_state_machine, "/SM_ROOT"
    )
    intro_server.start()
