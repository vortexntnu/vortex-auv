...
def main():
    ...
    simulator_state_machine = StateMachine(
    ...
    with simulator_state_machine:
        ...
        StateMachine.add(
            "REACH_DEPTH", dp_move(0, 0), transitions={"succeeded": "GATE_SM"}
        )
        ...
        with gate_sm:
            ...
            StateMachine.add(
                ...
                transitions={
                    "succeeded": "PREPARE_MOVE_THROUGH",
                    "aborted": "GATE_SEARCH",
                },
            ...
            def prep_goal_cb(userdata, goal):
                ...
                prep_goal.target_pose.position.x = (
                    userdata.goal_position.x + (x_dist / abs(x_dist)) / 2
                )
                prep_goal.guidance_type = "PositionHold"
                return prep_goal

            StateMachine.add(
                "PREPARE_MOVE_THROUGH",
                SimpleActionState(
                    move_action_server,
                    MoveAction,
