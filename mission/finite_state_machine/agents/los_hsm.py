...
class TaskManager():
	...
	def __init__(self):
		...
		with hsm_pool_patrol:
			...
			StateMachine.add('DOCKING', ControlMode(OPEN_LOOP), transitions={'succeeded':'p0','aborted':'','preempted':''})
			StateMachine.add('p0', nav_transit_states['p0'], transitions={'succeeded':'p1','aborted':'','preempted':''})
			StateMachine.add('p1', nav_transit_states['p1'], transitions={'succeeded':'p2','aborted':'','preempted':''})
			StateMachine.add('p2', nav_transit_states['p2'], transitions={'succeeded':'p3','aborted':'','preempted':''})
			StateMachine.add('p3', nav_transit_states['p3'], transitions={'succeeded':'p4','aborted':'','preempted':''})
			StateMachine.add('p4', nav_transit_states['p4'], transitions={'succeeded':'','aborted':'','preempted':''})
