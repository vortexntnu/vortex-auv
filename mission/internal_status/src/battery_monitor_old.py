...
class BatteryMonitor:
    ...
    def __init__(self):
        ...
        # Parameters
        self.path_to_powersense = rospy.get_param("/battery/system/path",
                                                  default="/dev/i2c-1")
        ...
        rospy.loginfo("PSM Voltage I2C address: '0x{:02x}'".format(
        ...
        # set up callbacks
        self.log_timer = rospy.Timer(rospy.Duration(secs=logging_interval),
                                     self.log_cb)
        ...
        if not self.is_PSM_fuckd_voltage:
            ...
            rospy.logwarn(
                "System Battery Monitoring from PSM is not available.")
