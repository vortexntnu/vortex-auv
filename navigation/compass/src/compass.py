...
class Compass:
    def __init__(self):
        ...
        # parameters
        magnetometer_topic = rospy.get_param(
            "magnetometer_topic", default="/zed2/zed_node/imu/mag"
        )
        ...
        self.compass_pub_deg = rospy.Publisher(
            heading_topic + "_deg", Float32, queue_size=1
        )
        self.magnetometer_sub = rospy.Subscriber(
            magnetometer_topic, MagneticField, self.magnetometer_cb
        )
