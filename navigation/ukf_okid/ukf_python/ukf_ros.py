...
class UKFNode(Node):
    def __init__(self):
        ...
        #subcribers
        self.dvl_subscriber = self.create_subscription(TwistWithCovarianceStamped,
            "/orca/twist",
            self.dvl_callback,
    ...
    def dvl_callback(self, msg: TwistWithCovarianceStamped):
        ...
        dvl_measurement.covariance = np.array([[msg.twist.covariance[0], msg.twist.covariance[1], msg.twist.covariance[3]],
        ...
        self.current_state = self.ukf.posteriori_estimate(self.current_state, dvl_measurement)
        self.ukf_flagg = True
    
    def control_callback(self, msg:WrenchStamped):
        # unpack message
        control_array = np.array([msg.wrench.force.x, msg.wrench.force.y, msg.wrench.force.z, msg.wrench.torque.x, msg.wrench.torque.y, msg.wrench.torque.z])
