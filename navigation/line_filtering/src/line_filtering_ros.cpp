...
Camera3DPointsNode::Camera3DPointsNode() : Node("camera_3d_points_node")
{
   ...
   depth_sub_ = this->create_subscription<std_msgs::msg::Float64>(
    "dvl/depth", 10, std::bind(&Camera3DPointsNode::depthCallback, this, std::placeholders::_1));
...
{
    double depth = msg->data;
    RCLCPP_INFO(this->get_logger(), "Received depth: %f", depth);
}