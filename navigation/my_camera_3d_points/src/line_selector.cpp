...
filter the lines into active and next line. Lines received as a pose stamped
message receiving lines as 3d endpoints donn| know het whhere start and end, use
orientation of camera to decide with x/y coord


kham has transformed points to 3d
function that uses the 2d points, and sorts/groups the points to a line in
camera frame receiving either 0, 2 or 4 points for line, as poseArray
*/
...
// There is a possibility that the Y-coordinates at intersection is not at the
// exact same pixel
LineGrouper lines_grouped(double point1_,
                          double point2_,
                          double point3_ = 0,
                          double point4_ = 0) {
...
LineGrouper line_selector(lines_combined.line1_ line1,
                          lines_combined.line2 line2) {
