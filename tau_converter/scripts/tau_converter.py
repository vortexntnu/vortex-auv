...
class TauRepublisher():
    ...
    def __init__(self, topic):
        ...
        self.dpTauSub = rospy.Subscriber(topic, Wrench, self.tau_repub_callback)
        self.tauPub = rospy.Publisher('/thrust/desired_forces/flipped', Wrench, queue_size=1)
...
if __name__ == '__main__':
    try:
        tau_repub_node = TauRepublisher(
            topic='/thrust/desired_forces')
        tau_repub_node.spin()
